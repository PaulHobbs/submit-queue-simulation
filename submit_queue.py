...
# Precompute randoms to avoid waiting on bottleneck random.rand() at runtime. 10^7 should be enough: even if it loops it's ok!
_MAX_RAND = 10000000
rands = random.rand(_MAX_RAND)
_rand_i = 0
...
if __name__ == "__main__":
    N_ITER = 4000
    N_CHANGES_PER_HOUR = [10] * 8 + [120] * 8 + [20] * 8
