#!/usr/bin/env python3
"""
Robust hyperparameter optimizer with multi-scenario evaluation.

Tests configurations across different traffic, culprit rate, and test stability
scenarios to find parameters that work well under varying conditions.
"""
...
class Optimizer:
    ...
    def optimize(self, n_trials: int = 100) -> optuna.Study:
        ...
        print("="*80)
        print("ROBUST OPTIMIZATION - Multi-Scenario Evaluation")
        print("="*80)
        print(f"\nScenarios:")
